...
class RandomCameraCuriosityImpl : RandomCuriosityService {
    override suspend fun getRandomCuriosityData(sol: Int, page: Int): RandomCameraDTO {
        return try {
            ...
            HTTPClient.ktorClientWithCache.get("https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=$sol&page=$page&api_key=${BookMarksVM.dbImplementation.localDBData().getAPIKeys()[0].currentNASAAPIKey}")
                .body()
        }catch (_:Exception){
