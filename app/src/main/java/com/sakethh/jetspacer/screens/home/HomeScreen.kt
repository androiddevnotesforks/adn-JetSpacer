...
fun APODCardComposable(
    ...
    if (bookMarkedCategory == "roversdb") {
    ...
    Card(
        ...
        Column(modifier = Modifier.animateContentSize()) {
            ...
            val categoryChipText: String =
                if (bookMarkedCategory == "apoddb") {
                    "APOD"
                } else if (bookMarkedCategory == "roversdb") {
                    roverName
                } else {
                    ""
                }
...
fun AlertDialogForDeletingFromDB(
    ...
    val dialogText: String = if (bookMarkedCategory == "roversdb") {
    ...
    } else if (bookMarkedCategory == "newsdb") {
    ...
    } else if (bookMarkedCategory == "settingscreen") {
        ...
        AlertDialog(
            ...
            title = {
                ...
                Button(
                    ...
                    Text(
                        text = if (bookMarkedCategory == "settingscreen") "Remove them ASAP!" else "Remove it ASAP!",
                        style = MaterialTheme.typography.headlineMedium,
                        color = MaterialTheme.colorScheme.primary
                    )
                }
